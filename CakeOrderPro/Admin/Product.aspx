<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="CakeOrderPro.Admin.Product" %>

<%@ Import Namespace="CakeOrderPro" %>
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                            ErrorMessage="Quantity must be non nagative" ForeColor="Red" Display="Dynamic"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cs %>" SelectCommand="SELECT [CategoryId], [Name] FROM [Catagories]">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:FileUpload ID="fuProductImage" runat="server" class="form-control"
